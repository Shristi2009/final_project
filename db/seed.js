...
async function createInitialItems() {
  try {
    ...
    const kingVitaman = await createItem({ name: 'King Vitaman', price: 3, description: "Bursting with flavor and a delicious crunch, Kellogg’s® Froot Loops® Cereal is the fruitiest way to start your day.", picture: "king_vitaman.jpg"  });
    ...
    const honeyBunchesOfOats = await createItem({ name: 'Honey Bunches of Oats', price: 3, description: "Honey Bunches of Oats Honey Roasted started it all. Our classic cereal that created the forever iconic flavor lineup of crispy flakes, crunchy oat clusters and a touch of honey.", picture: "honey_nut_cheerios.jpg"  });
